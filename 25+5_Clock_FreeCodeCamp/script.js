...
const Clock = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("div", {
      className: "bg-dark min-vh-100 d-flex flex-column align-items-center justify-content-center" }, /*#__PURE__*/

    React.createElement("div", {
      className: "bg-white container text-center rounded-3 d-flex flex-column justify-content-center align-items-center p-3" }, /*#__PURE__*/

    React.createElement("div", null, /*#__PURE__*/
    React.createElement("h1", null, " 25 + 5 Clock")), /*#__PURE__*/

    React.createElement("div", {
      className: "d-flex flex-row align-items-center justify-content-center gap-5" }, /*#__PURE__*/
    ...
    React.createElement("i", { class: "bi bi-arrow-down-square" })), /*#__PURE__*/
    ...
    React.createElement("i", { class: "bi bi-arrow-up-square" })))), /*#__PURE__*/
    ...
    React.createElement("div", {
      style: { width: "50%" },
      className: `border border-4 rounded-3 p-3 ${label === `Session` ? 'border-dark text-black' : `border-danger text-danger`} ` }, /*#__PURE__*/
    ...
    detik < 10 ? "0" + detik : detik)), /*#__PURE__*/
    ...
    React.createElement("i", { class: "bi bi-play" })), /*#__PURE__*/

    React.createElement("button", {
      className: "btn btn-dark fs-4 ms-2 me-2" }, /*#__PURE__*/

    React.createElement("i", { class: "bi bi-pause" })), /*#__PURE__*/
    ...
    React.createElement("i", { class: "bi bi-arrow-clockwise" })))), /*#__PURE__*/
    ...
    React.createElement("a", {
      ...
      href: "https://ardifjar443.github.io" }, "ArdiFjar443")))), /*#__PURE__*/
