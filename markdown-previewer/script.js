...
`);
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: "text-center", style: { backgroundColor: "#bae8e8" } }, " Code by ", /*#__PURE__*/React.createElement("a", { href: "https://ardifjar443.github.io", target: "_black", className: "text-decoration-none text-dark" }, "Ardifjar443")), /*#__PURE__*/
    React.createElement("div", { className: " min-vh-100 d-flex align-items-center justify-content-center ", style: { backgroundColor: "#bae8e8" } }, /*#__PURE__*/
    React.createElement("div", { style: { backgroundColor: "#fffffe" }, className: "p-4  border border-5 border-dark rounded-3" }, /*#__PURE__*/
    ...
    React.createElement("div", { style: { backgroundColor: "#fffffe" }, className: "p-4  border border-5 border-dark rounded-3  container-class col-xs-12 col-md-6" }, /*#__PURE__*/
